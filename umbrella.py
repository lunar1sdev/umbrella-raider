...
# This project is licensed under the Cwelium License, which includes additionalpip
...
class Render:
    def __init__(self):
        try:
            ...
            self.size = 80  # Default size for GUI mode
        ...
        try:
            ...
            match response.status_code:
                ...
                case _:
                    ...
                    return "__dcfduid=62f9e16000a211ef8089eda5bffbf7f9; __sdcfduid=62f9e16100a211ef8089eda5bffbf7f98e904ba04346eacdf57ee4af97bdd94e4c16f7df1db5132bea9132dd26b21a2a; __cfruid=a2ccd7637937e6a41e6888bdb6e8225cd0a6f8e0-1714045775; _cfuvid=s_CLUzmUvmiXyXPSv91CzlxP00pxRJpqEhuUgJql85Y-1714045775095-0.0.1.1-604800000; locale=en-US", "default_fingerprint"
        except Exception as e:
